      ...
      <tr>
        ...
        <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr>
            ...
            <td width="25%" height="18" background="assets/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">邮箱</div></td>
          ...
          <c:forEach  items="${users}"  var="u">
	          	<tr>
		            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
		              <input name="userCb" type="checkbox" class="STYLE2" value="${u.id}" />
		            </div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF" class="STYLE2"><div align="center" class="STYLE2 STYLE1">${u.id }</div></td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">${u.username }</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">${u.email }</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center">
            			<span class="STYLE1">[</span>
	            			<img src="assets/images/037.gif" width="9" height="9" />
            				<a  href="power/usersAction!updateChooseRoleView.action?userId=${u.id}" >分配角色</a>
            			<span class="STYLE1">]</span>
	            		<span class="STYLE1">[</span>
