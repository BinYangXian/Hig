...
<head>
    ...
    <script type="text/javascript">
    	$(function(){
    		$.ajax({
    			url:'power/usersAction!updateFindCheckedRoles.action',
    			data:{"user.id":"${param.userId}"},
    			dataType:'json',
    			success:function(json){
    				$(':checkbox[name="roleIds"]').each(function(i,o){
    					o.checked = json.indexOf(parseInt($(o).val()))!=-1;
    				});
    			}
    		})
    	})
    	...
    	<td>
    		<table width="100%" border="0" cellspacing="0" cellpadding="0">
    			<tr>
			        ...
			        <td  bgcolor="#f3ffe3">
			            <form action="power/usersAction!updateChooseRole.action" method="post" style="width: 100px;padding-left:100px;">
			            	<div style="text-align: left;margin-bottom: 20px;">
				            	<input type="hidden" name="user.id" value="${param.userId }">
