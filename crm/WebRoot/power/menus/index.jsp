  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="1101" background="assets/images/tab_05.gif"><img src="assets/images/311.gif" width="16" height="16" /> <span class="STYLE4">菜单列表</span></td>
      ...
      <tr>
        ...
        <td bgcolor="#f3ffe3"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#c0de98">
          <tr>
            ...
            <td width="10%" height="18" background="assets/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">菜单编码</div></td>
            <td width="25%" height="18" background="assets/images/tab_14.gif" class="STYLE1"><div align="center" class="STYLE2 STYLE1">菜单名</div></td>
          ...
          <c:forEach  items="${menus}"  var="m">
	          	<tr>
		            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
		              <input name="userCb" type="checkbox" class="STYLE2" value="${m.menuId}" />
		            </div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF" class="STYLE2"><div align="center" class="STYLE2 STYLE1">${m.menuId }</div></td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">${m.menuName }</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center">
