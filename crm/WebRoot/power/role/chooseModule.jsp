		...
		$(function(){
			...
			$('input.power').bind('click',function(){
				...
				$.ajax({
					...
					type:'post',
					data:{"role.id":"${role.id}","moduleId":moduleId,"powerCode":powerCode}
				});
			});
          ...
          <c:forEach items="${modules}"  var="m">
	          	<tr>
		            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
		              <input name="userCb" type="checkbox" class="STYLE2" value="${m.id }" />
		            </div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF" class="STYLE2"><div align="center" class="STYLE2 STYLE1">${m.id }</div></td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">${m.name }</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">
            			<input type="checkbox" class="power" ${utils.permission(powers.get(m.id),1)?'checked="checked"':'' } moduleId="${m.id }" value="1">
	            	</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">
            			<input type="checkbox" class="power" ${utils.permission(powers.get(m.id),2)?'checked="checked"':'' } moduleId="${m.id }" value="2">
	            	</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">
            			<input type="checkbox" class="power" ${utils.permission(powers.get(m.id),4)?'checked="checked"':'' } moduleId="${m.id }" value="4">
	            	</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">
            			<input type="checkbox" class="power" ${utils.permission(powers.get(m.id),8)?'checked="checked"':'' } moduleId="${m.id }" value="8">
	            	</div>
	            </td>
	          </tr>
          </c:forEach>
