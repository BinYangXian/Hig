...
<html>
	...
	<body>
					...
					<table class="table table-bordered table-hover">
						...
						<c:forEach items="${users }" var="user">
							<tr>
								...
								<td>${user.age }</td>
								<td width="200">
									<button class="btn btn-warning btn-sm" data-users-id="${user.id }" data-toggle="modal" data-target="#updateUser" ><i class="glyphicon glyphicon-pencil"></i> 修改</button>
									<a href="myUsersAction!delete.action?id=${user.id }" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> 删除</a>
								</td>
							</tr>
						</c:forEach>
		...
		<form action="myUsersAction!addUser.action" method="post" class="form-horizontal">
		...
		<form action="myUsersAction!update" method="post" class="form-horizontal" id="form1">
