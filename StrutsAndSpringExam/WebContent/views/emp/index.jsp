...
<html>
	...
	<body>
						...
						<c:forEach items="${emps }" var="e">
							<tr>
								...
								<td width="200">
									...
									<a href="empAction!delete?emp.empno=${e.empno }" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> 删除</a>
								</td>
							</tr>
						</c:forEach>
		...
		<form action="empAction!save" method="post" class="form-horizontal">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control" name="emp.empno" placeholder="员工编号">
								</div>
							</div>
							<div class="form-group">
		...
		<form action="empAction!update" method="post" class="form-horizontal">
