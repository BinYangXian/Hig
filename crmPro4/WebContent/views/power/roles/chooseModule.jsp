...
<html>
	...
	<script type="text/javascript">
		$(function(){
			...
			$(':checkbox.power').bind('click',function(){
				var $this = $(this);
				$.ajax({
					url:'power/roleAction!updateChooseModule.action',
					type:'post',
					data:{"roleId":"${param.roleId}","moduleId":$this.data('module-id'),"powerCode":$this.val(),"add":$this[0].checked},
					success:function(){}
				})
			})
		})
          ...
          <c:forEach items="${modules}"  var="m">
	          	<tr>
		            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
		              <input name="userCb" type="checkbox" class="STYLE2" value="${m.moduleId }" />
		            </div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF" class="STYLE2"><div align="center" class="STYLE2 STYLE1">${m.moduleId }</div></td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">${m.moduleName }</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">
            			<input type="checkbox" class="power" ${permission.hasPermission(powers[m.moduleId],1)?'checked="checked"':'' } data-module-id="${m.moduleId }"  value="1">
	            	</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">
            			<input type="checkbox" class="power" ${permission.hasPermission(powers[m.moduleId],2)?'checked="checked"':'' } data-module-id="${m.moduleId }" value="2">
	            	</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">
            			<input type="checkbox" class="power" ${permission.hasPermission(powers[m.moduleId],4)?'checked="checked"':'' } data-module-id="${m.moduleId }" value="4">
	            	</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">
            			<input type="checkbox" class="power" ${permission.hasPermission(powers[m.moduleId],8)?'checked="checked"':'' } data-module-id="${m.moduleId }" value="8">
	            	</div>
	            </td>
	          </tr>
          </c:forEach>
