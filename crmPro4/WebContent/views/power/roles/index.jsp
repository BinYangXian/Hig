  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="1101" background="assets/images/tab_05.gif"><img src="assets/images/311.gif" width="16" height="16" /> <span class="STYLE4">角色列表</span></td>
          ...
          <c:forEach  items="${roles}"  var="r">
	          	<tr>
		            <td height="18" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
		              <input name="userCb" type="checkbox" class="STYLE2" value="${r.roleId}" />
		            </div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF" class="STYLE2"><div align="center" class="STYLE2 STYLE1">${r.roleId }</div></td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center" class="STYLE2 STYLE1">${r.roleName }</div>
	            </td>
	            <td height="18" bgcolor="#FFFFFF">
	            	<div align="center">
            			<span class="STYLE1">[</span>
	            			<img src="assets/images/037.gif" width="9" height="9" />
            				<a  href="power/roleAction!updateChooseMenuView.action?roleId=${r.roleId}" >分配菜单</a>
            			<span class="STYLE1">]</span>
            			<span class="STYLE1">[</span>
	            			<img src="assets/images/037.gif" width="9" height="9" />
            				<a  href="power/roleAction!updateChooseModuleView.action?roleId=${r.roleId}" >分配模块</a>
            			<span class="STYLE1">]</span>
	            		<span class="STYLE1">[</span>
